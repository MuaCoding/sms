...
module.exports = {
  dev: {
    ...
    proxyTable: {
      '/api/**': { // '/api':匹配项
        // target: 'https://api.am.upup.cn/', //设置你调用的接口域名和端口号 别忘了加http
        target: 'http://10.32.5.204:3000/',
        // target: 'http://127.0.0.1:3000/',
        // target: 'http://10.83.61.41:3000/',
        changeOrigin: true,
        pathRewrite: {
    ...
    host: '10.32.4.248', // can be overwritten by process.env.HOST
